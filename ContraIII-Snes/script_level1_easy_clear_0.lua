--end episode on death or level end
--small scroll and score reward
--big death penalty, big level clear reward, boss clear reward
...
function done_check()
  ...
  elseif data.lives < prev_lives then
    --potential issue if playing with cheats and gain a life but already have 100
...
prev_score = 0
death_score = -100.01 -- -1. ---1.0 * math.log(10000)
