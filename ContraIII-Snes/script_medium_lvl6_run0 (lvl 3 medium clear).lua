...
level = data.level
function done_check()
  --print("calling done check in lua")
...
prev_score = 0
death_score = -1.01 -- -1. ---1.0 * math.log(10000)
level_clear_bonus = 10.5 --math.log(100000)
boss_clear_bonus = 4.0
...
weapon_lost_reward = -1.0
weapon_gained_reward = 3.0
weapon_have_reward = 1.0
